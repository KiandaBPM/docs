...
3. An **Edit form** dialog box appears on your screen. There are 8 different fields to fill in.
   ...
   - **Activate with** - Will decide when the form will be active. If you have several forms attached to a process, then select from a dropdown list the form you want to activate with the current form. In our case we will leave this blank.
