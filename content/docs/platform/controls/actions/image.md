...
6. A **New field - Image** dialog box will automatically open, giving you options for your new Image field: 
   ...
   ![Image field dialog box](/images/image-dialog.jpg)
...
8. You can preview how the image will look to an end user by first saving the changes you've made to your form (by clicking on the **Save** button ![Save](/images/saveprocess.png)) and then clicking the **Preview** ![Preview button](/images/preview.png) button.
