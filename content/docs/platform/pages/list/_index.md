...
## How to get started with the List widget ##
...
6. To change the list settings, that is the way the list looks, title and so on, click on the **Settings** button ![Settings button](/images/cog.png)and go to [List widget](pages/list.md) to find out more about edit options.
...
9. When you have completed your changes, click on the **Save** button ![Save button](/images/save-dash.png) to save your changes or **X** to quit without saving. 
